...
namespace lua::native
{
	...
	static int LUA_NATIVE_NETWORK_GET_BATTLEYE_INIT_STATE_()
	{
		auto retval = NETWORK::_GET_BATTLEYE_INIT_STATE();
		return retval;
	}
	...
	void init_native_binding_NETWORK(sol::state& L)
	{
		...
		NETWORK.set_function("GET_BATTLEYE_INIT_STATE_", LUA_NATIVE_NETWORK_GET_BATTLEYE_INIT_STATE_);
